...
// Cek login (bisa admin, dpl, mahasiswa, lembaga)
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action == 'update_profile') {
        ...
        if (empty($nama_baru) || empty($email_baru)) {
            ...
            $check->execute([$email_baru, $user_id]);
            ...
            if ($check->rowCount() > 0) {
                ...
                try {
                    ...
                    $stmt->execute([$nama_baru, $email_baru, $user_id]);
        ...
        if (empty($pass_lama) || empty($pass_baru) || empty($konfirmasi_pass)) {
            ...
            if (!$pass_valid) {
                ...
                try {
                    ...
                    // Optional: Auto logout setelah ganti password
                    // header("Location: ../logout.php");
                    // exit();
                } catch (PDOException $e) {
    ...
    <main class="main-content">
        ...
        <div class="container">
                ...
                <form method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="form-note">ID pengguna tidak dapat diubah</div>
                        </div>
                        <div class="form-group">
                            <label>Role</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= date('d F Y, H:i', strtotime($user['created_at'])) ?> WIB" disabled>
                    </div>
            ...
            <div class="card">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password_lama" class="form-control" required placeholder="Masukkan password lama Anda">
                    </div>
            ...
            <div class="card account-info">
                <h2 class="card-title">ℹ️ Informasi Akun</h2>
                <div class="account-grid">
                    ...
                    <div class="account-item">
                        <div class="label">NIP/NPM</div>
                        <div class="value"><?= htmlspecialchars($user['npm_nip']) ?></div>
                    </div>
                    <div class="account-item">
                    ...
                    <div class="account-item">
                        ...
                        <div class="value"><span class="status-active">Aktif</span></div>
                    </div>
                    <div class="account-item">
